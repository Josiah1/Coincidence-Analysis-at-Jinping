...
// Fri May 11 16:58:19 2018 by ROOT version 6.10/08
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Fold;
   Int_t           FileNum[6];   //[Fold]
   Int_t           TrigNum[6];   //[Fold]
   Int_t           TrigSec[6];   //[Fold]
   Int_t           TrigNano[6];   //[Fold]
   Double_t        dis[6];   //[Fold]
   Double_t        E[6];   //[Fold]
   Double_t        X[6];   //[Fold]
   Double_t        Y[6];   //[Fold]
   Double_t        Z[6];   //[Fold]
   Double_t        D2First[6];   //[Fold]
   Double_t        T2PrevSubEvt[6];   //[Fold]
   Double_t        Quadrant[6];   //[Fold]
   Double_t        QMax2Sum[6];   //[Fold]
