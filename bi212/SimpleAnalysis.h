...
// Sat May 26 21:05:28 2018 by ROOT version 6.10/08
...
public :
   ...
   TTreeReaderValue<Double_t> TotalPEp = {fReader, "TotalPEp"};
   TTreeReaderValue<Double_t> TotalPEd = {fReader, "TotalPEd"};
   TTreeReaderValue<Double_t> pdtime = {fReader, "pdtime"};
   TTreeReaderValue<Double_t> pddistance = {fReader, "pddistance"};
