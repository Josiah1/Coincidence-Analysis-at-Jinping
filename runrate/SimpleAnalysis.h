...
// Wed May 30 02:14:36 2018 by ROOT version 6.10/08
// from TTree SimpleAnalysis/Analysis Stream Tree
// found on file: Analysis_331.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReaderValue<Double_t> truthVertexX = {fReader, "truthVertexX"};
   TTreeReaderValue<Double_t> truthVertexY = {fReader, "truthVertexY"};
   TTreeReaderValue<Double_t> truthVertexZ = {fReader, "truthVertexZ"};
   TTreeReaderValue<Double_t> truthVertexEk = {fReader, "truthVertexEk"};
   TTreeReaderValue<Double_t> truthdECX = {fReader, "truthdECX"};
   TTreeReaderValue<Double_t> truthdECY = {fReader, "truthdECY"};
   TTreeReaderValue<Double_t> truthdECZ = {fReader, "truthdECZ"};
   TTreeReaderValue<Double_t> truthdE = {fReader, "truthdE"};
